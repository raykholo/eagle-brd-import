    ...
    return {
        ...
        draw3dVias: function(layersName) {
            ...
            for (var signalKey in this.eagle.signalItems) {
                ...
                layerVias.forEach(function(via) {
                    ...
                    /*
                    var rFlip1 = (Math.PI / 180) * 180;
                    var axisFlip1 = new THREE.Vector3(0, 1, 0);
                    if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                        console.log("ray: Bottom Flip Vias (loc1)");
                        that.rotateAroundObjectAxis(line, axisFlip1, rFlip1);
                        //placeholder for translating object by x or y board length
                    }   //pads not getting flipped
                    */
                    ...
                    /*
                    var rFlip2 = (Math.PI / 180) * 180;
                    var axisFlip2 = new THREE.Vector3(0, 1, 0);
                    if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                        console.log("ray: Bottom Flip Vias (loc2)");
                        that.rotateAroundObjectAxis(mesh, axisFlip2, rFlip2);
                        //placeholder for translating object by x or y board length
                    }   //pads not getting flipped
                    */
        ...
        draw3dElements: function(layer) {
            ...
            for (var elemKey in this.eagle.elements) {
                ...
                var axisFlip1 = new THREE.Vector3(0, 1, 0);
                if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                    console.log("ray: Bottom Flip SMDs");
                    that.rotateAroundObjectAxis(smdgroup, axisFlip1, rFlip1);
                    //placeholder for translating object by x or y board length
                }   //SMDs flip code
                */
                ...
                padgroup.children.forEach(function(group) {
                    ...
                    group.children.forEach(function(line) {
                        ...
                        if (line.position.x == 0) { // only middle point holes
                            ...
                            //var tempCircle = this.drawCircle(vector.x, vector.y, drill / 2, this.colorHole);
                            /*
                            var rFlip3 = (Math.PI / 180) * 180;
                            var axisFlip3 = new THREE.Vector3(0, 1, 0);
                            if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                                console.log("ray: Bottom Flip Circles");
                                that.rotateAroundObjectAxis(tempCircle, axisFlip3, rFlip3);
                                //placeholder for translating object by x or y board length
                            } //circles flip code
                            */
                            
                            //this.sceneAdd (tempCircle);
                    ...
                    */
                    ...
                    var axisFlip2 = new THREE.Vector3(0, 1, 0);
                    if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                        console.log("ray: Bottom Flip Pads");
                        that.rotateAroundObjectAxis(mesh, axisFlip2, rFlip2);
                        //placeholder for translating object by x or y board length
                    } //pads flip code
                    */
                ...
                */
                ...
                pkg.wires.forEach(function(wire) {
                    ...
                    /*
                    var rFlip4 = (Math.PI / 180) * 180;
                    var axisFlip4 = new THREE.Vector3(0, 1, 0);
                    if (this.activeLayer == 'Bottom' && this.flipTheBoard == true) { //If bottom layer flip board
                        console.log("ray: Bottom Flip Polygons");
                        that.rotateAroundObjectAxis(line, axisFlip4, rFlip4);
                        //placeholder for translating object by x or y board length
                    } //pkgWires flip code ?what is this for?
                    */
                    //that.sceneAdd(line);
                    bigSceneGroup.add (line); 
